 ...
 * @author uset
 */
public class theBest extends javax.swing.JFrame {

    public int id;
    public theBest() throws SQLException, IOException {
        initComponents();
        myInit();
    ...
    public theBest(int id) throws SQLException, IOException {
        this.id=id;
        initComponents();
        myInit();
        this.setLocationRelativeTo(null);
    ...
    public void myInit() throws SQLException, MalformedURLException, IOException{
       // DefaultTableModel model = (DefaultTableModel)tablo.getModel();
        ...
        b.myRs=b.myStat.executeQuery("select isbn,avg(book_rating) from book_ratings group by isbn,book_rating order by book_rating desc limit 10;");
        ...
        while(b.myRs.next()){
            ...
            rating[i]=b.myRs.getInt("avg(book_rating)");
            i++;
        }
        
        Kitap k;
        for(i=0;i<10;i++){
            b.myRs=b.myStat.executeQuery("select * from books where isbn='"+isbn[i]+"'");
            while(b.myRs.next()){
        ...
        for(i=0;i<10;i++){
            ...
            satir[i][3]=rating[i];
            satir[i][4]=list.get(i).getISBN();
        }
        
        String[] columnName = {"Kapak","Name","Author","Rating","ISBN"};
    ...
    private void initComponents() {
        ...
        jLabel3.setText("En İyi 10 Kitap");
    ...
    private void TabloMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_TabloMouseClicked
        ...
        String kitapAdi = model2.getValueAt(index, 4).toString();
        ReadingInfo r;
        try {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(theBest.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
